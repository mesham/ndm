...
void ThreadPool::startThread(void (*callFunction)(void *), void *args) { startListenerThread(callFunction, args); }

int ThreadPool::startListenerThread(void (*callFunction)(void *), void *args) {
